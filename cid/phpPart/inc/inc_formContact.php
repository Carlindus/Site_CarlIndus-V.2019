...
$contactFormWindow = new Window('contactForm', 'CarlIndus Design - Messagerie', $contactForm);
...
$thanksWindow = new Window('confirmSendForm', 'Réception de votre message', $thanksMessage );
